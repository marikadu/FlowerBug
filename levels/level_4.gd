...
func spawn_flower():
	...
	# 65% normal flower, 35% carnivorous
	if randf() < 0.65:
...
## This level does not have a bird/enemy
...
# Transitioning to the next cutscene after the player has collected the needed amount of pollen
func _on_shaking_4():
